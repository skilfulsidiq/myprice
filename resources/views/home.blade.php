...
@if(Auth::user()->isNew())
  <div class="panel panel-white">
        ...
        <div class="panel-body pb">
            <form action="{{route('shopownwer.setupstore')}}" method="POST" id="shopownerform" enctype="multipart/form-data">
                {{csrf_field()}}
                {{ method_field('POST') }}
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-3">
                        <div class="form-group">
                            ...
                            <textarea name="url" placeholder="Page Url" rows="3" class="form-control"></textarea>
                            @if ($errors->has('url'))
